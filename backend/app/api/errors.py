...
def domain_error_status(exc: DomainError) -> int:
    status_map: dict[str, int] = {
        ...
        "ITEM_NOT_FOUND": 404,
        "USER_NOT_FOUND": 404,
        "SETTLEMENT_REQUEST_NOT_FOUND": 404,
        "OCR_JOB_NOT_FOUND": 404,
        "PARSED_RECEIPT_NOT_FOUND": 404,
        ...
        "USERNAME_TAKEN": 409,
        "ITEM_SPLIT_EQUALLY": 409,
        "ITEM_HAS_CLAIMS": 409,
        "WRONG_SPLIT_MODE": 409,
        "UNCLAIMED_ITEMS_EXIST": 400,
        "VPA_NOT_SET": 422,
        "SETTLEMENT_NOT_READY": 422,
        "ROOM_NOT_LOCKED_OR_SETTLING": 422,
        "INSUFFICIENT_PARTICIPANTS": 422,
        "ROOM_LOCKED": 423,
        "RECEIPT_LOCKED": 423,
        "OCR_PROVIDER_UNAVAILABLE": 422,
        "OCR_PROVIDER_TIMEOUT": 422,
        "OCR_PROVIDER_FAILED": 422,
        "ROOM_EXPIRED": 403,
        "ROOM_CLOSED": 403,
