...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("status IN ('pending','processing','succeeded','failed')", name="ck_ocr_jobs_status"),
    ...
    op.create_table(
        ...
        sa.Column("adjustments", postgresql.JSONB(astext_type=sa.Text()), server_default="[]", nullable=False),
