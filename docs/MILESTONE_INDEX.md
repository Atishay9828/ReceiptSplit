...
| M016 Persistent Rooms, Friends, Multi-Bill Ledger & Mixed Item Splits | FULL PASS | `b444a54`, `a50fad6`, `d37af6f`, `7f6ff5e` | Persistent groups with multiple bills, usernames/friends, partial settlement claims, cumulative pending/cleared ledger, and mixed individual/equal items are deployed. Live public and signed-in smoke passed, including Google login, friend-by-username, separate rooms, two bills in one trip room, mixed shared/individual items, pending settlement retained for later clearing, and active-bill totals before locking. |
